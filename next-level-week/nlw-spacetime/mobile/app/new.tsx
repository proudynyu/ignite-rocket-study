    ...
    return (
        <ScrollView className="flex-1 px-8" contentContainerStyle={{ paddingBottom: bottom, paddingTop: top }}>
            ...
            <View className="mt-6 space-y-6">
                ...
                <TouchableOpacity className="h-32 items-center justify-center rounded-lg border border-dashed border-gray-500 bg-black/07" activeOpacity={0.7} onPress={openImagePicker}>
                    { cover ?
                        <Image source={{ uri: cover }} className="h-full w-full rounded-lg object-cover" />
                        :
                        (<View className="flex-row items-center gap-2">
