    ...
    return (
        <form onSubmit={handleCreateMemory} className="flex flex-1 flex-col gap-2">
            ...
            <textarea 
                name="content"
                spellCheck={false}
                className="w-full flex-1 resize-none rounded border-0 bg-transparente p-0 text-lg leading-relaxed text-gray-100 placeholder:text-gray-400 focus:ring-0"
                placeholder="Fique livre para adicionar fotos, videos e relatos sobre essa experiencia que voce quer lembrar para sempre!"
            />
            <button type="submit" className="inline-block self-end rounded-full bg-green-500 px-5 font-alt text-sm uppercase leading-none text-black hover:bg-green-600">
                Salvar
            </button>
        </form>
    )
